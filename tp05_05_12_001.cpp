...
int main()
{
    ...
    //unsigned int delay_time = ((CONTROL_PORT.REG_TXCONTROL0.LONG >> 16)&0xFFFF)*100*28;
   ...
   // idle(0,delay_time);
    ...
    delay_time = ((CONTROL_PORT.REG_TXCONTROL0.LONG >> 16)&0xFFFF)*100*28;
    
    idle(0,delay_time);

    status_flag = lin_slave_GetBSFieldStatusFlag();
